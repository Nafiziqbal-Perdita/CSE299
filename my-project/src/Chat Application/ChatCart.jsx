                ...
                <div className="h-16  rounded-full  " >
                    <svg
                        ...
                        <g fill="none">
                            ...
                            <path fill="#10b981" d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10a9.95 9.95 0 0 1-5.168-1.438l-3.032.892A1.01 1.01 0 0 1 2.546 20.2l.892-3.032A9.958 9.958 0 0 1 2 12C2 6.477 6.477 2 12 2Zm-3.5 8.5a1.5 1.5 0 1 0 0 3a1.5 1.5 0 0 0 0-3Zm7 0a1.5 1.5 0 1 0 0 3a1.5 1.5 0 0 0 0-3Z" />
                        </g>
                    </svg>
                </div>
